...
ActiveRecord::Schema.define(version: 2019_03_31_010140) do
  ...
  create_table "dj_memberships", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "room_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["room_id"], name: "index_dj_memberships_on_room_id"
    t.index ["user_id"], name: "index_dj_memberships_on_user_id"
  end
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.json "avatar_data"
    t.json "avatar_urls", default: [], null: false
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "dj_memberships", "rooms"
